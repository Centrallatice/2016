...
/* /modules/caroussel/layout/innerArticle.twig */
class __TwigTemplate_2698f7937480f4a90092a50ca13e925bfcd1dd49fb82897011f7e9da7846b247 extends Twig_Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            ...
            if ((($this->getAttribute($_i_, "groupe", array()) == null) || ($this->getAttribute($_i_, "groupe", array()) != $_groupeencours_))) {
                ...
                if (($this->getAttribute($_i_, "libelle", array()) != "")) {
                    // line 14
                    echo "                           <span style=\"font-style:italic;padding:5px 0;text-align:center;font-size:11px;display:block;
                                 line-height:11px;background-color:";
                    // line 15
                    if (isset($context["dataPage"])) { $_dataPage_ = $context["dataPage"]; } else { $_dataPage_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_dataPage_, "ColorCategorie", array()), "html", null, true);
                    echo ";color:white\"><strong>";
                    if (isset($context["i"])) { $_i_ = $context["i"]; } else { $_i_ = null; }
    ...
    {
        return "/modules/caroussel/layout/innerArticle.twig";
    }
...
/*                        {% if i.libelle!='' %}*/
/*                            <span style="font-style:italic;padding:5px 0;text-align:center;font-size:11px;display:block;*/
/*                                  line-height:11px;background-color:{{dataPage.ColorCategorie}};color:white"><strong>{{i.libelle}}</strong></span>*/
/*                        {% endif %}*/
