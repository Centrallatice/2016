...
/* @culture-loisirs/articlesLayout/ONE_COL_NO_TXT.twig */
class __TwigTemplate_de01e8c6a3adedac2cfa068668f6a3eea1a6b33632c1404b71f268b948e8dd6f extends Twig_Template
{
    ...
    <div class=\"col-xs-24\">
        ...
        ";
            ...
            if (($this->getAttribute($_arti_, "typeCaroussel", array()) == "images")) {
                ...
                if (isset($context["arti"])) { $_arti_ = $context["arti"]; } else { $_arti_ = null; }
                $this->loadTemplate((("@" . $_themesRep_) . "/modules/caroussel/layout/innerArticle.twig"), "@culture-loisirs/articlesLayout/ONE_COL_NO_TXT.twig", 18)->display(array_merge($context, array("carou" => $this->getAttribute($_arti_, "contentCarou", array()), "repimg" => $this->getAttribute($_arti_, "urlCarou", array()))));
                // line 19
                echo "            ";
                ...
                if (isset($context["themesRep"])) { $_themesRep_ = $context["themesRep"]; } else { $_themesRep_ = null; }
                if (isset($context["arti"])) { $_arti_ = $context["arti"]; } else { $_arti_ = null; }
                $this->loadTemplate((("@" . $_themesRep_) . "/modules/caroussel/layout/innerArticleDocs.twig"), "@culture-loisirs/articlesLayout/ONE_COL_NO_TXT.twig", 20)->display(array_merge($context, array("carou" => $this->getAttribute($_arti_, "contentCarou", array()), "repimg" => $this->getAttribute($_arti_, "urlCarou", array()))));
                // line 21
                echo "            ";
            }
            // line 22
...
";
    ...
    {
        return "@culture-loisirs/articlesLayout/ONE_COL_NO_TXT.twig";
    }
