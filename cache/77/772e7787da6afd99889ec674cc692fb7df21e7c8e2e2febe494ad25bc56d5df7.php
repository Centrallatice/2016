...
/* @famille/articlesLayout/TWO_COLS_IMG_LEFT.twig */
class __TwigTemplate_0ad5e77a2adedb2f5ae7b19b766de919a136060fa8604818710f0ee85943e28c extends Twig_Template
{
    ...
    ";
            ...
            echo "       ";
            if (isset($context["arti"])) { $_arti_ = $context["arti"]; } else { $_arti_ = null; }
            $this->loadTemplate("/modules/caroussel/layout/innerArticle.twig", "@famille/articlesLayout/TWO_COLS_IMG_LEFT.twig", 18)->display(array_merge($context, array("carou" => $this->getAttribute($_arti_, "contentCarou", array()), "repimg" => $this->getAttribute($_arti_, "urlCarou", array()))));
            // line 19
            echo "    ";
        }
        echo " 
...
";
    ...
    {
        return "@famille/articlesLayout/TWO_COLS_IMG_LEFT.twig";
    }
