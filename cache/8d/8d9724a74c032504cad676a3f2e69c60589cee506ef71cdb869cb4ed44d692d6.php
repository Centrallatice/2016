...
/* @culture-loisirs/articlesLayout/TWO_COLS_IMG_LEFT.twig */
class __TwigTemplate_25c9392d945e72cf55ef50eee8e907c1f3cf83ad5692f57b091a8f5589100c38 extends Twig_Template
{
    ...
    ";
            ...
            echo "       ";
            if (isset($context["arti"])) { $_arti_ = $context["arti"]; } else { $_arti_ = null; }
            $this->loadTemplate("/modules/caroussel/layout/innerArticle.twig", "@culture-loisirs/articlesLayout/TWO_COLS_IMG_LEFT.twig", 18)->display(array_merge($context, array("carou" => $this->getAttribute($_arti_, "contentCarou", array()), "repimg" => $this->getAttribute($_arti_, "urlCarou", array()))));
            // line 19
            echo "    ";
        }
        echo " 
...
";
    ...
    {
        return "@culture-loisirs/articlesLayout/TWO_COLS_IMG_LEFT.twig";
    }
