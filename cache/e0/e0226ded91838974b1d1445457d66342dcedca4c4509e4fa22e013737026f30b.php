...
/* @culture-loisirs/contentPage.twig */
class __TwigTemplate_b405c21bd54e93cb4c4eae6c1d79a237f0016ce859d9fcb54fb73ce14f460dc7 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("base.twig", "@culture-loisirs/contentPage.twig", 1);
        $this->blocks = array(
...
";
    ...
    public function block_body($context, array $blocks = array())
    {
        // line 50
        echo "    ";
        $this->loadTemplate("global/header.twig", "@culture-loisirs/contentPage.twig", 50)->display(array_merge($context, array("breadcrumbsarticle" => 1)));
        // line 51
        echo "    
    ...
    <div class=\"bloc-maincontainer contentPage ";
        ...
        if ((twig_length_filter($this->env, $_pagemenu_) > 0)) {
            ...
            echo "                    ";
            if (isset($context["themesRep"])) { $_themesRep_ = $context["themesRep"]; } else { $_themesRep_ = null; }
            $this->loadTemplate((("@" . $_themesRep_) . "/modules/menus/layout/displayLeftColumn.twig"), "@culture-loisirs/contentPage.twig", 60)->display($context);
            // line 61
            echo "                ";
        }
        // line 62
        ...
        if ((twig_length_filter($this->env, $_articles_) > 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["arti"]) {
                ...
                if (isset($context["CompteurCol"])) { $_CompteurCol_ = $context["CompteurCol"]; } else { $_CompteurCol_ = null; }
                if (isset($context["articles"])) { $_articles_ = $context["articles"]; } else { $_articles_ = null; }
                $this->loadTemplate($_template_, "@culture-loisirs/contentPage.twig", 89)->display(array_merge($context, array("CompteurCol" => $_CompteurCol_, "artiTotal" => twig_length_filter($this->env, $_articles_))));
                // line 90
                echo "                            ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
        ...
        if ($this->getAttribute($_modules_, "BOTTOM_PAGE", array(), "array")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["carou"]) {
                ...
                if (($this->getAttribute($_carou_, "type", array()) == "caroussel")) {
                    ...
                    echo "                                ";
                    if (isset($context["themesRep"])) { $_themesRep_ = $context["themesRep"]; } else { $_themesRep_ = null; }
                    $this->loadTemplate((("@" . $_themesRep_) . "/modules/caroussel/layout/displayBottomPage.twig"), "@culture-loisirs/contentPage.twig", 116)->display($context);
                    // line 117
                    echo "                            ";
                }
                // line 118
        ...
        if ($this->getAttribute($_modules_, "COL_RIGHT_ONE", array(), "array")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["m"]) {
                ...
                if (($this->getAttribute($_m_, "type", array()) == "customcontent")) {
                    ...
                    echo "                                ";
                    if (isset($context["themesRep"])) { $_themesRep_ = $context["themesRep"]; } else { $_themesRep_ = null; }
                    $this->loadTemplate((("@" . $_themesRep_) . "/modules/blocdownload/layout/displayRightColumn.twig"), "@culture-loisirs/contentPage.twig", 131)->display($context);
                    // line 132
                    echo "                            ";
                }
                // line 133
        ...
        if ($this->getAttribute($_modules_, "COL_RIGHT_TWO", array(), "array")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["m"]) {
                ...
                if (($this->getAttribute($_m_, "type", array()) == "blocdownload")) {
                    ...
                    echo "                                ";
                    if (isset($context["themesRep"])) { $_themesRep_ = $context["themesRep"]; } else { $_themesRep_ = null; }
                    $this->loadTemplate((("@" . $_themesRep_) . "/modules/blocdownload/layout/displayRightColumn.twig"), "@culture-loisirs/contentPage.twig", 139)->display($context);
                    // line 140
                    echo "                            ";
        ...
        // line 150
        if (isset($context["themesRep"])) { $_themesRep_ = $context["themesRep"]; } else { $_themesRep_ = null; }
        $this->loadTemplate((("@" . $_themesRep_) . "/blocks/services/layout/displayMiniInnerColRight.twig"), "@culture-loisirs/contentPage.twig", 150)->display($context);
        // line 151
        echo "            </div>
        </div>
    ";
        // line 153
        $this->loadTemplate("global/footer.twig", "@culture-loisirs/contentPage.twig", 153)->display($context);
        echo "    
    </div>
...
";
    ...
    {
        return "@culture-loisirs/contentPage.twig";
    }
